...
{
    class ResponsibleExecutorsParserAppeal : IResponsibleExecutorsParser
    {
        public ResponsibleExecutorStorage Parse(string[] textFromFileLines, ResponsibleExecutorStorage responsibleExecutorStorage)
        {
            ...
            foreach (string line in textFromFileLines)
            {
                ...
                responsibleExecutorStorage.IncrementAppeal(name);
            }
        ...
        private string getName(string line)
        {
            ...
            {
                Console.WriteLine("Не удалось распарсит имя в списке обращений.");
                throw new Exception("Can't parse name in appeal.");
            }
        }
    }
}
